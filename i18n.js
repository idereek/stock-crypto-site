...
const I18N = {
  mn: {
    ...
    auth_error_unconfirmed: "Имэйл хараахан баталгаажаагүй байна — инбоксоо шалгаарай.",
    auth_error_invalid_credentials: "Имэйл эсвэл нууц үг буруу байна.",
    auth_error_already_registered: "Энэ имэйл хаягаар аль хэдийн бүртгүүлсэн байна — Нэвтрэх tab руу шилжиж үзээрэй.",
    auth_resend_link: "Дахин илгээх",
    ...
    hero_post: " уншъя",
    eyebrow: "Ticker эсвэл нэрээр хайх — жишээ: AAPL эсвэл Apple, BTC эсвэл Bitcoin",
  ...
  en: {
    ...
    auth_error_unconfirmed: "Your email hasn't been confirmed yet — please check your inbox.",
    auth_error_invalid_credentials: "Incorrect email or password.",
    auth_error_already_registered: "This email is already registered — try the Log In tab instead.",
